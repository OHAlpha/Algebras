...
@InvertableOperator
@DistributativeOperator(over = RealAdditionOperator.class)
public class RealMultiplicationOperator extends SetBinaryOperator<Double>
		implements UnitalBinaryOperator<Double>,
		DivisionBinaryOperator<Double>, InvertableBinaryOperator<Double> {

	public static final RealMultiplicationOperator operator = new RealMultiplicationOperator();

	private RealMultiplicationOperator() {
	...
	public static void main(String[] args) {
		...
		if (false) {
			...
			for (AnnotatedType ai : ais) {
				...
				try {
					ClassLoader loader = RealMultiplicationOperator.class
							.getClassLoader();
