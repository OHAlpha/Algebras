...
@DistributativeOperator(over = WholeAdditionOperator.class)
public class WholeMultiplicationOperator extends SetBinaryOperator<Integer>
		implements UnitalBinaryOperator<Integer> {

	public static final WholeMultiplicationOperator operator = new WholeMultiplicationOperator();

	private WholeMultiplicationOperator() {
	...
	public static void main(String[] args) {
		...
		if (false) {
			...
			for (AnnotatedType ai : ais) {
				...
				try {
					ClassLoader loader = WholeMultiplicationOperator.class
							.getClassLoader();
