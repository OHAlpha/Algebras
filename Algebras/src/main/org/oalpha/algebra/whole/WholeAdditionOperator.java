...
public class WholeAdditionOperator extends SetBinaryOperator<Integer> implements
		UnitalBinaryOperator<Integer> {

	public static final WholeAdditionOperator operator = new WholeAdditionOperator();

	private WholeAdditionOperator() {
	...
	public static void main(String[] args) {
		...
		if (false) {
			...
			for (AnnotatedType ai : ais) {
				...
				try {
					ClassLoader loader = WholeAdditionOperator.class
							.getClassLoader();
