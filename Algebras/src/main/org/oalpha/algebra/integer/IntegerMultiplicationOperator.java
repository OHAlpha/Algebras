...
@DistributativeOperator(over = IntegerAdditionOperator.class)
public class IntegerMultiplicationOperator extends SetBinaryOperator<Integer>
		implements UnitalBinaryOperator<Integer> {

	public static final IntegerMultiplicationOperator operator = new IntegerMultiplicationOperator();

	private IntegerMultiplicationOperator() {
	...
	public static void main(String[] args) {
		...
		if (false) {
			...
			for (AnnotatedType ai : ais) {
				...
				try {
					ClassLoader loader = IntegerMultiplicationOperator.class
							.getClassLoader();
